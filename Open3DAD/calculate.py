...
# Final output
# Average number of points per point cloud
print("Average number of points per point cloud:", total_points / pcd_num)

# Percentage of anomalous points
print("Percentage of anomalous points:", total_anomaly_points / total_points)
